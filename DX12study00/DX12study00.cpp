                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_DX12STUDY00, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DX12STUDY00));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = ::LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DX12STUDY00)); //대문자
